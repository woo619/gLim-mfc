...
// MFC buttonDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "MFC button.h"
#include "MFC buttonDlg.h"
...
CMFCbuttonDlg::CMFCbuttonDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MFC_BUTTON_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMFCbuttonDlg, CDialogEx)
	...
	ON_WM_ERASEBKGND()
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_ON_OFF, &CMFCbuttonDlg::OnBnClickedBtnOnOff)
END_MESSAGE_MAP()


// CMFCbuttonDlg 메시지 처리기
...
void CMFCbuttonDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
BOOL CMFCbuttonDlg::OnEraseBkgnd(CDC* pDC)
{
...
void CMFCbuttonDlg::InitButtons()
{
...
void CMFCbuttonDlg::OnBnClickedBtnOnOff()
{
